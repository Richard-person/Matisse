...
public final class SelectionCreator {
    ...
    public SelectionCreator compress(boolean isCompress) {
        mSelectionSpec.isCompress = isCompress;
        return this;
    }
     ...
     * 压缩阈值
     *
     * @param compressSize 单位KB
     */
    public SelectionCreator compressSize(int compressSize) {
        mSelectionSpec.ignoreCompressSize = compressSize;
        return this;
    }
     ...
     * 是否显示图片压缩等待框
     */
    public SelectionCreator showCompressProgress(boolean isShowCompressProgress) {
        mSelectionSpec.isShowCompressProgress = isShowCompressProgress;
        return this;
    }
    ...
    public SelectionCreator cropOutPutMaxWidth(int cropMaxWidth) {
        mSelectionSpec.cropMaxWidth = cropMaxWidth;
        return this;
    }

    public SelectionCreator cropOutPutMaxHeight(int cropMaxHeight) {
        mSelectionSpec.cropMaxHeight = cropMaxHeight;
        return this;
    }

    public SelectionCreator cropAspect(int cropAspectX, int cropAspectY) {
        mSelectionSpec.cropAspectX = cropAspectX;
