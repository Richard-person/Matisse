...
public final class Matisse {
     ...
     */
    public static ArrayList<SelectedResult> obtainPathResult(Intent data) {
        if(data == null){
            return null;
        }

        Object object = data.getSerializableExtra(MatisseActivity.EXTRA_RESULT_SELECTION_PATH);
        if(object == null){
            return null;
        }
        return (ArrayList<SelectedResult>) object;
    }
